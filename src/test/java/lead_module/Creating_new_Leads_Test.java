...
//Test case 8
public class Creating_new_Leads_Test {
...
//		Navigate to Home Page Click on 'Leads'
...
//		String cellValue1=sh.getRow(0).getCell(1).getStringCellValue();
//		String cellValue2 = sh.getRow(1).getCell(1).getStringCellValue();
//		Random ran = new Random();
//		int random = ran.nextInt(500);
		
//		String lastName = cellValue1+"_"+random;
//		String companyName = cellValue2+"_"+random;
